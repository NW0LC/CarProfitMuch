...
class CardPackageListFragment : MyBaseFragment(), OnRefreshListener, View.OnClickListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    private val arrayList= ArrayList<ServiceOrderBean>()
    ...
    private fun iniData(){
        DataCtrlClass.cardPackageListData(context, currentPage) {
