package com.exz.carprofitmuch.module.mine.redpacket
...
import com.exz.carprofitmuch.adapter.RedPackageAdapter
...
class RedPackageListFragment : MyBaseFragment(), OnRefreshListener, View.OnClickListener, BaseQuickAdapter.RequestLoadMoreListener {

    private var refreshState = Constants.RefreshState.STATE_REFRESH
    private var currentPage = 1
    private lateinit var mAdapter: RedPackageAdapter<CouponBean>
    ...
    private fun iniData() {
        DataCtrlClassXZW.RedPackageData(context, currentPage) {
    ...
    companion object {
        ...
        fun newInstance(position: Int): RedPackageListFragment {
            val bundle = Bundle()
            val fragment = RedPackageListFragment()
