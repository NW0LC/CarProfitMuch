...
class RedPackageActivity : BaseActivity() {
    ...
    private fun initTabBar() {
        ...
        mFragments.add(RedPackageListFragment.newInstance(0))
        mFragments.add(RedPackageListFragment.newInstance(1))
        mFragments.add(RedPackageListFragment.newInstance(2))
