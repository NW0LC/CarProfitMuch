...
//            }
    ...
    public boolean performLongClick() {
        ...
        int x1 = (int) mMotionEvent.getX();
        int y1 = (int) mMotionEvent.getY();
        mMotionEvent = null;

        TagView child = findChild(x1, y1);
        int pos = findPosByView(child);
        if (child != null) {
            if (mOnTagClickListener != null) {
                return mOnTagClickListener.onTagLongClick(child.getTagView(), pos, this);
            }
        }
        return true;
    }
