package com.exz.carprofitmuch.widget;
...
public class ServicePayTimerView extends LinearLayout {
    ...
    public ServicePayTimerView(Context context) {
        super(context);
        init(context);
    }

    public ServicePayTimerView(Context context, AttributeSet attr) {
        super(context, attr);
        init(context);
    }
...
//        }
    ...
    class TimeItemView extends LinearLayout {
        private Context context;
        private TextSpaceChangeView numTv;
        ...
        public void setUnitText(byte tag) {
            switch (tag) {//改过
                case DAY_TAG:
                    getUnitTv().setText(" : ");
                    getNumTv().setBackground(ContextCompat.getDrawable(context, R.drawable.vector_service_pay_time  ));
                    getNumTv().setPadding(SizeUtils.dp2px(10),SizeUtils.dp2px(2),SizeUtils.dp2px(10),SizeUtils.dp2px(2));
...
//                    getNumTv().setTextColor(ContextCompat.getColor(context,R.color.red_de1a19));
        ...
        private TextView getNumTv() {
            if (numTv == null) {
                numTv = new TextSpaceChangeView(context);
                numTv.setTextColor(ContextCompat.getColor(context, R.color.White));
                numTv.setBackgroundColor(Color.WHITE);
                numTv.setTextSize(12);
                numTv.setSpacing(70f);
            }
            return numTv;
        }
