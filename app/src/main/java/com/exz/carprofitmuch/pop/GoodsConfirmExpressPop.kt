...
import com.exz.carprofitmuch.bean.ExpressBean
...
class GoodsConfirmExpressPop(context: Context) : BasePopupWindow(context), View.OnClickListener {
    ...
    var mAdapter: GoodsConfirmPopAdapter<ExpressBean> = GoodsConfirmPopAdapter()
    ...
    override fun onCreatePopupView(): View? {
        ...
        inflate.title.text=context.getString(R.string.goods_confirm_express_title)
        return inflate
    }
